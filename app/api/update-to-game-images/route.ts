...
export async function POST() {
  try {
    console.log('Updating to actual game images from /images/games folder...')
    ...
    const imageMapping: Record<string, { image: string; thumbnail: string }> = {
      ...
      'Codenames': { 
        ...
        thumbnail: '/images/games/codenames.jpg' 
      }
    }
    ...
    return NextResponse.json({ 
      message: 'Updated to actual game images from /images/games folder',
      summary: {
      ...
      note: 'Images now use actual game images from your /images/games folder'
    })
